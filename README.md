...
CAD is a different thing. I very sure want some enclosures, but do not have the full specs yet, so the desk part is not complete. The plant node is finished :jeej:, and the assembly drawing can be found in the CAD folder. I will make place for heated insterts for the sceen, once I know where to. (<= Desk node)
...
| This is a preview of the wiring |
|---------------------------------|
| <img width="636" height="307" alt="image" src="https://github.com/user-attachments/assets/1f618ef5-d53f-4071-8164-f786f76278a7" /> |
